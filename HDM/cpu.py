...
from HDM.backend import BackendBase
from HDM import utils

class CPU(BackendBase):   
    def __init__(self):
        super().__init__()
    ...
    def normalize_kernel(diffusion_matrix: coo_matrix) -> csr_matrix:
        ...
        normalized_kernel = CPU.symmetrize(normalized_kernel)
    ...
    def spectral_embedding(
        ...
        eigvals, eigvecs = CPU.eigendecomposition(config, kernel)
